...
if __name__ == '__main__':
    ...
    fout = open('/home/work/qinhuan/git/vision-detector/test/test_wwl/toqinhuan/txts/res_smallssd_change_min_size5_20fenming_0.5.txt', 'w')
    ...
    with open(test_list) as f:
        while True:
            ...
            for i in ids:
                ...
                #print (Label[i], Conf[i], Xmin[i], Ymin[i], Xmax[i], Ymax[i])
                fout.write('\n')
