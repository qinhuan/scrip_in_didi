...
def non_max_suppression_fast(num, x1, y1, x2, y2, conf, overlapThresh):
    if len(x1) == 0:
        return []
    pick = []
    area = (x2 - x1 + 1) * (y2 - y1 + 1)
    #idxs = np.argsort(conf)
    idxs = np.argsort(conf[num:]) + num
    tmp = []
    num = num - 1
    while num >= 0:
        tmp.append(num)
...
if __name__ == '__main__':
    ...
    model_def = '/home/work/qinhuan/git/vision-detector/test/test_wwl/mymodel/smallssd_change_min_size9/deploy.prototxt'
    model_weights = '/home/work/qinhuan/git/vision-detector/test/test_wwl/mymodel/smallssd_change_min_size9/final.caffemodel'
    ...
    fout = open('/home/work/qinhuan/git/vision-detector/test/test_wwl/toqinhuan/txts/res_smallssd_0.5_0.16_out25_change_nms.txt', 'w')
