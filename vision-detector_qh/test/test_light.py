...
ground_truth_dir = '/home/work/data/dididata/object-v170223/images'
dataset = 'DIDI'
...
def extract_box(sp, is_gt=True):
    ...
    if dataset == 'KITTI':
        ...
        if is_gt:
            ...
            return sp[0], float(sp[1]), float(sp[2]), float(sp[3]), float(sp[4]), float(sp[5])
    else:
        pass
...
if __name__ == '__main__':
    #parser = argument()
    gt_file = '/home/work/qinhuan/code/dataPro/test_light_txt.txt'
    result_files = ['/home/work/qinhuan/git/vision-detector/test/res.txt']
