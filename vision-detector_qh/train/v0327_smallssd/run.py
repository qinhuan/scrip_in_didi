...
label_map_file = '/tmp/toqinhuan/labelmap.prototxt'
name_size_file = '/tmp/toqinhuan/test_name_size.txt'
...
job_name = 'v0327_smallssd_kitti_{}x{}_vgg16-channel16-nopooling12_smallssd_change_min_size_sample'.format(resize_height, resize_width)
